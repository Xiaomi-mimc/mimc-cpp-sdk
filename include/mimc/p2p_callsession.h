...
public:
    ...
    uint16_t getP2PIntranetFileStreamId() const{ return this->P2PIntranetFileStreamId; }
    void setP2PIntranetFileStreamId(const uint16_t& P2PIntranetFileStreamId) { this->P2PIntranetFileStreamId = P2PIntranetFileStreamId; }
    ...
    bool isP2PIntranetOK() const{ return this->intranetBurrowState && (this->P2PIntranetConnId > 0);}
    ...
    uint16_t getP2PInternetFileStreamId() const{ return this->P2PInternetFileStreamId; }
    void setP2PInternetFileStreamId(const uint16_t& P2PInternetFileStreamId) { this->P2PInternetFileStreamId = P2PInternetFileStreamId; }
    ...
    bool isP2PInternetOK() const{ return this->internetBurrowState && (this->P2PInternetConnId > 0);}
